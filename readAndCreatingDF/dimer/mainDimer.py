...
from featureSelection import filterMethods, WrapperFeatureSelection, VarianceInflationFactor, greedy_algo
import datetime
...
# #PLOTTING OVER
    ...
    corr_op = greedy_algo.corr_with_output1(df)
    greedy_algo.greedy_algo(df,corr_op)
